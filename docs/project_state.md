...
## Active Context
- **Goal:** Transform the site into an "AI Visible" commerce engine (ACP/UCP).
- **Architecture:** Eleventy (SSG) + Cloudflare (Edge) + HubSpot (CRM) + Stripe ($$).
- **Recent Wins:**
...
## Known Issues
- **None.** Workspace is clean and verified (`OPS-CHECKS` passing).
